...
export const InputPrivateKeyDialog = observer((props: IComponentProps) => {
  ...
  return (
    <Modal motionPreset="slideInBottom" onClose={store.colseModal} isOpen={isOpen} size="xl" isCentered closeOnOverlayClick={false}>
      <ModalOverlay />
      <ModalContent w={{ base: '90%', md: '100%' }}>
        ...
        <ModalBody py="1.25rem" color="textPrimary" fontFamily="Roboto">
          <Box color={color}>
            <Flex  mt='15px' alignItems={['flex-start', 'center']} mb="3" direction={['column', 'row']}>
        ...
        <ModalFooter borderTop="1px" borderColor="borderLight">
          <Button size="sm" onClick={store.colseModal} mr="0.5rem" bg="transparent" border="1px" borderColor="borderBtn">
            Cancel
          </Button>
          <Button w="62px" size="sm"  onClick={() => store.next()} disabled={store.buttonDisable} color="lightColor" bg="brandColor">
              Next
          </Button>
        </ModalFooter>
      </ModalContent>
